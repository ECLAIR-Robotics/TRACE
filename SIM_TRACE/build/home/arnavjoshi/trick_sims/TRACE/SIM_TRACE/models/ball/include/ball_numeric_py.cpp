...
/*-----------------------------------------------
              @(target):= _m28df78b22963a8506682986bdd4e0292.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m28df78b22963a8506682986bdd4e0292

#else
#  define SWIG_init    init_m28df78b22963a8506682986bdd4e0292

#endif
#define SWIG_name    "_m28df78b22963a8506682986bdd4e0292"
...
SWIGINTERN PyObject *_wrap_robot_integ(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  BALL *arg1 = (BALL *) 0 ;
  PyObject *swig_obj[1] ;
  int result;
...
SWIGINTERN PyObject *_wrap_robot_deriv(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  BALL *arg1 = (BALL *) 0 ;
  PyObject *swig_obj[1] ;
  int result;
  ...
  result = (int)robot_deriv(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "robot_deriv" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "robot_integ", _wrap_robot_integ, METH_O, NULL},
	 { "robot_deriv", _wrap_robot_deriv, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
