...
/* Created 2025/02/28 01:26:32 arnavjoshi $ */
#include "../S_source.hh"
...
int TRACESimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            ...
            break ;
        case 1:
            robot_default_data( &ball ) ;
            break ;
        case 2:
            robot_deriv( &ball ) ;
            break ;
        case 3:
            trick_ret = robot_integ( &ball ) ;
            break ;
        case 4:
            robot_shutdown( &ball ) ;
            break ;
...
double TRACESimObject::call_function_double ( Trick::JobData * curr_job ) {
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_HOME"] = "/home/arnavjoshi/trick";
    ...
    local_env["TRICK_PATH"] = "/home/arnavjoshi/trick/libexec/bin";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-isystem/home/arnavjoshi/trick/trick_source -isystem/home/arnavjoshi/trick/include -isystem/home/arnavjoshi/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic  -DUSE_ER7_UTILS_INTEGRATORS -fexceptions";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-isystem/home/arnavjoshi/trick/trick_source -isystem/home/arnavjoshi/trick/include -isystem/home/arnavjoshi/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic  -DUSE_ER7_UTILS_INTEGRATORS";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/arnavjoshi/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/arnavjoshi/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/arnavjoshi/.Trick_user_profile";
    ...
    local_env["XML_CATALOG_FILES"] = "/home/arnavjoshi/trick/libexec/trick_source/data_products/DPX/XML/catalog.xml";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.8.0-beta, Fri Feb 28 01:26:32 2025" ) ;
    exec_set_build_date( "Fri Feb 28 01:26:32 2025" ) ;
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"TRACESimObject", 0, "dyn", 0, NULL) ;
    ...
    dyn_integloop.getIntegrator(Runge_Kutta_4, 8);
